...
c1 = l1.cards.create(title: 'abs all day errday', description: 'feel the burn')
c2 = l1.cards.create(title: 'swimming laps', description: 'i can float')
c3 = l1.cards.create(title: 'pullups', description: 'ouchy')
...
i2 = c2.items.create(done: true, title: 'mocha')
i3 = c3.items.create(done: true, title: 'cookie')
#############
...
i12 = c14.items.create(done: false, title: 'cookie')
i13 = c15.items.create(done: true, title: 'mocha')
i14 = c15.items.create(done: false, title: 'cookie')
